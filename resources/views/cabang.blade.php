    ...
    <div class="col">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Semua cabang</h4>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="#"><button class="btn btn-danger hapus" type="button" title="Delete" data-id="{{ $item->id }}" data-nama="{{$item->kota}}"><i class="bi bi-trash"></i></button></a>
                  </td>
                </tr> 
                @empty
                <tr>
...
<script>
  $('.hapus').click(function() {
    ...
    .then((willDelete) => {
      if (willDelete) {
        window.location = "/delcabang/" + deleteid + " ",
