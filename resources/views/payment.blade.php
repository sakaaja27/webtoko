    ...
    <div class="col">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Jenis Payments</h4>
      ...
      <div class="modal-body">
        <form action="{{route('payment.store')}}" method="POST">
          ...
          <div class="row gx-3 mb-3 text">
            <div class="col-md-4">
              <label class="form-label">Nama Payment</label>
              <input type="text"  name="payment" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
            <div class="col-md-4">
              <label class="form-label">No Rekening</label>
              <input type="text"  name="rekening" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
